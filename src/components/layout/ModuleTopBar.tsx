// src/components/layout/MainTopBar.tsx (Updated)
...
export default function ModuleTopBar({ onSearch }: ModuleTopBarProps) {
  ...
  return (
    <TooltipProvider>
      <header className="bg-white border-b border-slate-200 z-40 sticky top-0">
        <div className="flex items-center justify-between h-15 px-6">
          {/* Left Side - Hamburger Menu + Company Info */}
            ...
            <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
              <SheetTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-9 w-9 rounded-md hover:bg-slate-100 transition-all duration-200"
              ...
              <SheetContent
                side="left"
                className="p-0 w-64 border-r border-slate-200 bg-white"
              >
                <ModuleSidebar
                  companyName={currentCompany?.business_name}
