...
export default function ReportPreviewHub() {
  ...
  const handleBack = () => {
    navigate(`/company/${companyId}/payroll/${payrollRunId}/reports`);
  };
        ...
        <CardHeader className="pb-4 border-b border-slate-200">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className="bg-[#7F5EFD] hover:bg-[#6a4ce0] text-white rounded-sm"
              size="sm"
            >
                    ...
                    {xlsxSheets.map((sheet, idx) => (
                      <button
                        ...
                        className={`
                          ...
                          ${activeSheet === idx 
                            ? 'bg-white text-[#7F5EFD] border-t border-x border-gray-200 -mb-px' 
