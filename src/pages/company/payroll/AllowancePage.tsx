...
import AllowanceAssignSection from "@/components/company/payroll/allowances/assign/AllowanceAssignSection";
...
export default function DeductionPage() {
  ...
  const renderTabContent = () => {
    switch (currentTab) {
      case "manage":
        return <AllowanceManageSection />;
      case "assign":
        return <AllowanceAssignSection />;
      default:
        return null;
    }
  };
